...
class CDEvaluator():
    ...
    def __init__(self, args):
        ...
        # self.device = paddle.device("cuda:%s" % args.gpu_ids[0]
        #                            if paddle.cuda.is_available() and len(args.gpu_ids)>0
        #                            else "cpu")
        #
        # print(self.device)
    ...
    def load_checkpoint(self, checkpoint_name='best_ckpt.pdparams'):
        ...
        if os.path.exists(os.path.join(self.checkpoint_dir, checkpoint_name)):
            ...
            checkpoint = paddle.load(os.path.join(self.checkpoint_dir, checkpoint_name)
                                    )
